  ...
  return (
    <>
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <div className="flex items-center gap-2 border border-slate-700 rounded-full p-1 pr-3 text-sm mt-20">
          <span className="bg-indigo-600 text-xs px-3 py-1 rounded-full">NEW</span>
          <p className="flex items-center gap-2"> 
            <span>Try our new job ready templates </span>
          </p>
        </div>
        ...
        <p className="text-center text-base max-w-md mt-2">
         Craft beautiful, ATS-friendly resumes effortlessly powered by AI.
        </p>
