    ...
    <section className="py-24 px-4 md:px-8 lg:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r  from-blue-700 to-yellow-600 bg-clip-text text-transparent text-nowrap">
            ...
            <div key={index} className="relative">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -top-2 -right-2 w-12 h-12 rounded-full bg-background border-4 border-primary flex items-center justify-center">
